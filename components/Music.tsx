        ...
        <div className="grid gap-4">
          {TOP_TRACKS.map((track, index) => (
            ...
            >
              ...
              <div className="hidden md:block text-gray-400 text-sm mx-8">
                {track.plays} plays
              </div>

              <div className="text-gray-400 text-sm font-mono mr-4">
                {track.duration}
              </div>

              <div className="flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="text-gray-400 hover:text-neon-pink" onClick={(e) => e.preventDefault()}>
